    ...
    return (
        <div className="px-8 xl:px-36 py-10">
            ...
            <div className="py-10">
                ...
                <div className="text-lg">JavaScript, React, TailwindCSS, Node/Express, REST, JSON Schema, JSON Web Tokens, PostgreSQL, MapQuest, AWS S3, Jest, SuperTest, Git, GitHub</div>
            </div>
        </div>
    )
}
